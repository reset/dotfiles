...
### settings.json permissions to apply on a new machine

Add the following to the `permissions.allow` array in `~/.claude/settings.json` to suppress per-session prompts for the `/briefing` skill and general Atlassian read tools:
